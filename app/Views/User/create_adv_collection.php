 ...
 <div class="container">
    <div class="row">
        <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 mt-5 pt-3 pb-3 bg-white from-wrapper">
            <div class="container">
                <h3 class="center-align"><?php echo lang('Lang.crate_adv_col.create_col');?></h3>
                
                <form class="" action="<?=base_url()?>/User/create_adv_collection" method="post">
                    <div class="row">
                        <div class="form-group col-12 col-sm-6">
                            <label for="collectionName"><?php echo lang('Lang.crate_adv_col.title');?></label>
                        ...
                        <div class="form-group center-align">
                            <button type="submit"  class="btn btn-primary btn-xl btn-block col s12 light-blue darken-4"><?php echo lang('Lang.crate_adv_col.create');?></button>
                        </div>
                </form>
            </div>
        </div>
